...
var maze = function(center){
	...
	*/
	...
	maze.prototype.getRingCount = function(){
		return currRings;
	}
	...
	//Change the value of curr ring
	maze.prototype.incrementRing = function (v){
		currRings = currRings + v;
	}
...
var increaseButton = function(){
	this.button = new paper.PointText(new paper.Point(paper.view.bounds.right-50,paper.view.bounds.top+50));
	this.button.fontFamily = 'VT323';
	this.button.fontSize = 50;
	this.button.fontWeight = 'bold';
	this.button.content = '>';
	this.button.fillColor = 'red';
	this.button.shadowColor = 'red';
	this.button.shadowBlur = 12;

	this.buttonBox = new paper.Path.Rectangle(paper.view.bounds.right-50,paper.view.bounds.top+50,20,-29);
}

var decreaseButton = function(){
	this.button = new paper.PointText(new paper.Point(paper.view.bounds.right-100,paper.view.bounds.top+50));
	this.button.fontFamily = 'VT323';
	this.button.fontSize = 50;
	this.button.fontWeight = 'bold';
	this.button.content = '<';
	...
	this.buttonBox = new paper.Path.Rectangle(paper.view.bounds.right-100,paper.view.bounds.top+50,20,-29);
}

var newButton = function(){
	this.button = new paper.PointText(new paper.Point(paper.view.bounds.right-95,paper.view.bounds.top+100));
	this.button.fontFamily = 'VT323';
	this.button.fontSize = 50;
	this.button.fontWeight = 'bold';
	this.button.content = 'NEW';
	this.button.fillColor = 'red';
	this.button.shadowColor = 'red';
	this.button.shadowBlur = 12;

	this.buttonBox = new paper.Path.Rectangle(paper.view.bounds.right-95,paper.view.bounds.top+100,60,-29);
}

var ringCounter = function(){
	this.button = new paper.PointText(new paper.Point(paper.view.bounds.right-75,paper.view.bounds.top+50));
	this.button.fontFamily = 'VT323';
	this.button.fontSize = 50;
	this.button.fontWeight = 'bold';
	this.button.content = '3';
	this.button.fillColor = 'red';
	this.button.shadowColor = 'red';
	this.button.shadowBlur = 12;
}
